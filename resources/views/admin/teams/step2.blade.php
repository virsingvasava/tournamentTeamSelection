                        ...
                        <div class="col-md-6 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">4 Winning Teams</h4>
                                </div>
                                <div class="card-body">
                                    <form action="{{ route('admin.team.storeStep2') }}" class="form form-vertical" method="post">
                                        @csrf
                                        <div class="form-body">
                                            <div class="row">
                                                <div class="col-12" id="team-selection">
                                                    @foreach($teams as $team)
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="name" class="form-control @error('name') is-invalid @enderror" name="winners[]" value="{{ $team->name }}" readonly>
                                                            @error('name')
